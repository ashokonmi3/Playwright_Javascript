/* So if you want to demonstrate route mocking, you need a browser context and a page 
(or a fetch executed from the page). route will work with page.goto only
*/

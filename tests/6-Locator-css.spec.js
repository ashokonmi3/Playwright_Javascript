...
test.describe("CSS Selectors Example", () => {
  ...
  test("Demonstrate CSS Selectors", async () => {
     ...
     * - Class Name: Select elements based on their CSS class. tagname.classname
     * - ID: Select elements based on their unique ID. tagname#id
    ...
    // Example 3: Select an element by ID and click it tagname#id
